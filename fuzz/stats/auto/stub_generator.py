...
# Headers generated by create_plugin_stubs() with curated content.
# Avoid overwriting them in write_missing_header_stubs().
PLUGIN_MANAGED_STUB_HEADERS = {
    "core/core.h",
    "com/com.h",
    "plugins/IPlugin.h",
    "plugins/ISubSystem.h",
    ...
    "sys/prctl.h",
    "syscall.h",
    "interfaces/json/JAppManager.h",
    "interfaces/json/JsonData_AppManager.h",
}
...
def write_missing_header_stubs(stubs_dir: Path, missing_headers: Dict[str, str]) -> None:
    ...
    for inc in sorted(missing_headers):
        ...
        if should_skip_stub_generation(inc):
            continue
        if inc in PLUGIN_MANAGED_STUB_HEADERS:
            continue
        ...
        if resolved_from == "<generated-fallback>":
            ...
            if "json/json.h" == inc:
                ...
                header_path.write_text(
                    ...
                    "\n"
                    "enum {\n"
                    "    ID_PACKAGE_DOWNLOADER               = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x200,\n"
                    "    ID_PACKAGE_INFO_ITERATOR            = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x201,\n"
                    "    ID_PACKAGE_DOWNLOADER_NOTIFICATION  = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x202,\n"
                    "    ID_PACKAGE_INSTALLER                = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x203,\n"
                    "    ID_PACKAGE_ITERATOR                 = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x204,\n"
                    "    ID_PACKAGE_INSTALLER_NOTIFICATION   = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x205,\n"
                    "    ID_PACKAGE_KEY_VALUE_ITERATOR       = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x206,\n"
                    "    ID_PACKAGE_HANDLER                  = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x207,\n"
                    "    ID_PACKAGE_LOCK_ITERATOR            = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x208,\n"
                    "    ID_RUNTIME_MANAGER                  = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x220,\n"
                    "    ID_RUNTIME_MANAGER_NOTIFICATION     = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x221,\n"
                    "    ID_RDK_WINDOW_MANAGER               = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x240,\n"
                    "    ID_RDK_WINDOW_MANAGER_NOTIFICATION  = RPC::IDS::ID_EXTERNAL_CC_INTERFACE_OFFSET + 0x241\n"
                    "};\n"
                    "\n"
                    "} // namespace Exchange\n"
                    "} // namespace WPEFramework\n"
                ...
                header_path.write_text(
                    ...
                    "    };\n"
                    "\n"
                    "    class INotification : virtual public Core::IUnknown {\n"
                    "    public:\n"
                    "        virtual ~INotification() = default;\n"
            ...
            elif "interfaces/IAppStorageManager.h" == inc:
                header_path.write_text(
                    f"#ifndef {guard}\n"
                    f"#define {guard}\n"
                    "\n"
                    ...
                    "namespace Exchange {\n"
                    "\n"
                    "struct IAppStorageManager : virtual public Core::IUnknown {\n"
                    "    enum { ID = 0xF1001 };\n"
                    "    virtual ~IAppStorageManager() = default;\n"
                    "    virtual Core::hresult CreateStorage(const std::string& appId, const uint32_t& size, std::string& path, std::string& errorReason) = 0;\n"
                    "    virtual Core::hresult GetStorage(const std::string& appId, const int32_t& userId, const int32_t& groupId, std::string& path, uint32_t& size, uint32_t& used) = 0;\n"
                    "    virtual Core::hresult DeleteStorage(const std::string& appId, std::string& errorReason) = 0;\n"
                    "    virtual Core::hresult Clear(const std::string& appId, std::string& errorReason) = 0;\n"
                    "    virtual Core::hresult ClearAll(const std::string& storageType, std::string& errorReason) = 0;\n"
                    "};\n"
                    "\n"
                    "} // namespace Exchange\n"
                    "} // namespace WPEFramework\n"
            ...
            elif "interfaces/IDownloadManager.h" == inc:
                header_path.write_text(
                    f"#ifndef {guard}\n"
                    f"#define {guard}\n"
                    "\n"
                    ...
                    "namespace Exchange {\n"
                    "\n"
                    "struct IDownloadManager : virtual public Core::IUnknown {\n"
                    "    enum { ID = 0xF1002 };\n"
                    "\n"
                    "    struct INotification : virtual public Core::IUnknown {\n"
                    "        enum { ID = 0xF1003 };\n"
                    "        virtual ~INotification() = default;\n"
                    "        virtual void OnAppDownloadStatus(const std::string& downloadStatus) { (void)downloadStatus; }\n"
                    "    };\n"
                    "\n"
                    ...
                    "    virtual Core::hresult Download(const std::string& url, const std::string& destination, std::string& downloadId) = 0;\n"
                    "    virtual Core::hresult Pause(const std::string& downloadId) = 0;\n"
                    "    virtual Core::hresult Resume(const std::string& downloadId) = 0;\n"
                    "    virtual Core::hresult Cancel(const std::string& downloadId) = 0;\n"
                    "    virtual Core::hresult Delete(const std::string& fileName) = 0;\n"
                    "    virtual Core::hresult Progress(const std::string& downloadId, uint8_t& percent) = 0;\n"
                    "    virtual Core::hresult RateLimit(const std::string& downloadId, const uint32_t& bytesPerSecond) = 0;\n"
                    "};\n"
                    "\n"
                    "} // namespace Exchange\n"
                    "} // namespace WPEFramework\n"
