...
def main() -> None:
    ...
    parser.add_argument("--crashes-root", default="fuzz/stats/results/crashes")
    ...
    parser.add_argument("--report", default="fuzz/stats/results/fuzz_report.md")
    parser.add_argument("--reports-root", default="fuzz/stats/results/reports")
