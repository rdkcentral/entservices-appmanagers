...
testIntercept1()
{
    ...
    inputParams='{"jsonrpc":"2.0","id":"3","method": "org.rdk.RDKWindowManager.removeKeyIntercept", "params":{"clientId":"googletestapp","keyCode":65,"modifiers":"[\"shift\"]"}}'
    expectedResult='null'
...
testIntercept2()
{
    ...
    inputParams='{"jsonrpc":"2.0","id":"3","method": "org.rdk.RDKWindowManager.removeKeyIntercept", "params":{"clientId":"googletestapp","keyCode":66,"modifiers":"[\"shift\"]"}}'
    expectedResult='null'
    testAPI "removeKeyIntercept" "$inputParams" "$expectedResult"
...
testIntercept3()
{
    ...
    inputParams='{"jsonrpc":"2.0","id":"3","method": "org.rdk.RDKWindowManager.removeKeyIntercept", "params":{"clientId":"westerostest","keyCode":67,"modifiers":"[\"shift\"]"}}'
    expectedResult='null'
    testAPI "removeKeyIntercept" "$inputParams" "$expectedResult"
...
testIntercepts()
{
    ...
    inputParams='{"jsonrpc":"2.0","id":"3","method": "org.rdk.RDKWindowManager.removeKeyIntercept", "params":{"clientId":"westerostest","keyCode":79,"modifiers":"[]"}}'
    expectedResult='null'
    testAPI "removeKeyIntercept" "$inputParams" "$expectedResult"
