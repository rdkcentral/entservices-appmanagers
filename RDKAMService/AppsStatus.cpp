...
{
	SYSLOG(Logging::Startup, (string(_T("AppsStatus::registerForEvents - Events now registered via COM-RPC in RDKAMServiceHandler"))));

	// Event registration is now handled by RDKAMServiceHandler::StartAppManagerListener()
