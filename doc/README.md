...
|--------|-------------|---------------|
| **AppManager** | Primary API for application management. Orchestrates app lifecycle operations. | [View →](./AppManager.md) |
| **LifecycleManager** | State machine for application lifecycle transitions. | [View →](./LifecycleManager.md) |
| **RuntimeManager** | Container runtime using Dobby OCI. Handles execution and hibernation. | [View →](./RuntimeManager.md) |
| **PackageManager** | Package download, installation, locking, and uninstallation. | [View →](./PackageManager.md) |
| **DownloadManager** | HTTP downloads with priority queuing and rate limiting. | [View →](./DownloadManager.md) |
| **StorageManager** | Application-specific storage allocation and management. | [View →](./StorageManager.md) |
| **PreinstallManager** | Pre-installed application scanning and installation. | [View →](./PreinstallManager.md) |
| **RDKWindowManager** | Display creation, focus control, and key intercepts. | [View →](./RDKWindowManager.md) |
| **TelemetryMetrics** | Performance metrics and analytics collection. | [View →](./TelemetryMetrics.md) |
| **WebBridge** | WebSocket bridge for JSON-RPC communication. | [View →](./WebBridge.md) |
