...
public:
    ...
    MOCK_METHOD(WPEFramework::Core::hresult, Lock,(const string &packageId, const string &version, const LockReason &lockReason, uint32_t &lockId, string &unpackedPath, std::string &configMetadata, IPackageHandler::ILockIterator*& appMetadata) , (override));
    MOCK_METHOD(WPEFramework::Core::hresult, Unlock, (const string &packageId,const string &version), (override));
    MOCK_METHOD(WPEFramework::Core::hresult, GetLockedInfo, (const string &packageId,const string &version,string &unpackedPath, std::string &configMetadata, string &gatewayMetadataPath, bool &locked), (override));
...
public:
    ...
    MOCK_METHOD(WPEFramework::Core::hresult, Config, (const string &packageId, const string &version, std::string &configMetadata), (override));
    ...
    MOCK_METHOD(WPEFramework::Core::hresult, GetConfigForPackage, (const string &fileLocator, string& id, string &version, std::string &config), (override));
