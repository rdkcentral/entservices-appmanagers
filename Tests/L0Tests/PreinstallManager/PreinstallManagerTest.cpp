...
int main()
{
    ...
    const Case cases[] = {
        ...
        { "Impl_PIM_StartPreinstallWithNoInstallerFails",       Test_Impl_PIM_StartPreinstallWithNoInstallerFails       },        { "Impl_PIM_IsNewerVersion_NewerMajor",                  Test_Impl_PIM_IsNewerVersion_NewerMajor                  },
