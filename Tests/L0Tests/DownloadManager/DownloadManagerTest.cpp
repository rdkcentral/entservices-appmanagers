...
extern uint32_t Test_HttpClient_DownloadFileRejectsSymlinkWithoutTargetSideEffect();
...
int main()
{
    ...
    RUN_TEST(Test_HttpClient_DownloadFileRejectsSymlinkWithoutTargetSideEffect);
