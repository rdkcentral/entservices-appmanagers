...
extern uint32_t Test_NetworkConfigurationHelper_UpdatePermissionBasedNetworkConfiguration_InternetOnlyWithoutExistingNodeReturnsFalse();
...
int main()
{
    ...
    const Case cases[] = {
        ...
        { "NetworkConfigurationHelper_UpdatePermissionBasedNetworkConfiguration_InternetOnlyWithoutExistingNodeReturnsFalse", Test_NetworkConfigurationHelper_UpdatePermissionBasedNetworkConfiguration_InternetOnlyWithoutExistingNodeReturnsFalse },
