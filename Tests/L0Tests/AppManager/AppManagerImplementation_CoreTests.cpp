...
{
    // These L0 unit tests do not provide full service dependencies for Configure().
    // Avoid invoking destructor ASSERT paths that belong to production integration teardown.
    impl = nullptr;
}
