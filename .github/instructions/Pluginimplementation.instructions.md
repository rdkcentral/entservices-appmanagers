...
# Instruction Summary
  1. [Inter-Plugin Communication](https://github.com/rdkcentral/entservices-appmanagers/blob/develop/.github/instructions/Pluginimplementation.instructions.md#inter-plugin-communication)
  2. [On-Demand Plugin Interface Acquisition](https://github.com/rdkcentral/entservices-appmanagers/blob/develop/.github/instructions/Pluginimplementation.instructions.md#on-demand-plugin-interface-acquisition)
  3. [Reusing Plugin Interface Acquisition](https://github.com/rdkcentral/entservices-appmanagers/blob/develop/.github/instructions/Pluginimplementation.instructions.md#reusing-plugin-interface-acquisition)
  4. [Bootstrap Logging](https://github.com/rdkcentral/entservices-appmanagers/blob/develop/.github/instructions/Pluginimplementation.instructions.md#bootstrap-logging)
...
Telemetry Plugin accessing UserSettings(via COM-RPC) through the IShell Interface API **QueryInterfaceByCallsign()** exposed for each Plugin - (Refer https://github.com/rdkcentral/entservices-appmanagers/blob/7988b8a719e594782f041309ce2d079cf6f52863/Telemetry/TelemetryImplementation.cpp#L160 )
...
void StateChange(PluginHost::IShell* plugin) override {
    ...
    // --- Step 2: Handle ACTIVATED (Re-registration) ---
        ...
        // Check if this callsign is in our monitored list
        if (std::find(MonitoredCallsigns.begin(), MonitoredCallsigns.end(), callsign) != MonitoredCallsigns.end()) {
